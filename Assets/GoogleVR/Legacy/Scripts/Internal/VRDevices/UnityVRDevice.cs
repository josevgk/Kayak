...
namespace Gvr.Internal {
  public class UnityVRDevice : GvrDevice {
    ...
    public override void UpdateState() {
      this.headPose.Set(UnityEngine.VR.InputTracking.GetLocalPosition(UnityEngine.VR.VRNode.Head),
          UnityEngine.VR.InputTracking.GetLocalRotation(UnityEngine.VR.VRNode.Head));
    }
