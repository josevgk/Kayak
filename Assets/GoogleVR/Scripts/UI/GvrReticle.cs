  ...
  public void OnGazeStay(Camera camera, GameObject targetObject, Vector3 intersectionPosition,
    ...
    SetGazeTarget(intersectionPosition, isInteractive);
		if (gazedAt != null && gazeStartTime > 0f) {
			if (Time.time - gazeStartTime > 3f/* && ExecuteEvents.CanHandleEvent<TimedInputHandler> (gazedAt)*/) {
				gazeStartTime = -1;
				ExecuteEvents.Execute (gazedAt, null, (TimedInputHandler handler, BaseEventData data) => handler.HandlerTimedInput ());
			}
		}
  }
